...
export const KNOWLEDGE_QUIZ_QUESTIONS: KnowledgeQuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "「寝るときに時計を着けると重いです」",
      "「朝起きても疲れが取れない…それ、睡眠の質が原因かも？スコアで可视化して改善！」",
      "「睡眠は体に良いです」",
    ],
    correctIndex: 2,
  ...
  {
    id: "q_tiktok_loop_hook",
    category: "tiktok_hook",
    categoryLabel: "无缝循环完播技巧",
    categoryEmoji: "🔁",
    question: "在短视频结尾使用「无缝循环（Seamless Loop）」技巧的真正目的是什么？",
    options: [
      "仅仅为了省去剪辑时间",
      "让观众在不知不觉中完整多刷一遍视频，大幅飙升完播率（>100%）并触发推荐池",
      "为了让视频文件体积变得更小",
      "让平台判定视频出现播放故障",
    ],
    correctIndex: 1,
    explanation: "无缝循环将结尾的最后一句话与开头第一句话语法拼合。用户在意识到视频结束前就已经重头开始了，完播率突破 100%~120%，算法会迅速判定为顶级热门内容！",
    workImpact: "实战技巧：结尾说「...所以大家千万不要问我」，紧接开头「为什么这款手表只要...」！",
    rewardAffinity: 30,
    rewardExp: 40,
    rewardCoins: 25,
  },
  {
    id: "q_japan_compliance",
    category: "japan_market",
    categoryLabel: "日本合规与信任感",
    categoryEmoji: "🛡️",
    question: "在面向日本市场推广无线蓝牙智能手表时，产品包装与宣传中必须具备哪项官方认证以消除买家顾虑？",
    options: [
      "美国 FCC 认证即可，日本没有要求",
      "欧盟 CE 认证即可，日本无需额外标志",
      "日本技适认证（TELEC / GITEKI 技適マーク），证明符合日本电波法",
      "仅需店铺自主手写的品质保证卡",
    ],
    correctIndex: 2,
    explanation: "日本消费者法制意识与维权意识极强，蓝牙设备必须具备「技適マーク」（技术基准适合证明）。文案或主图中注明「技適認証済み」能瞬间化解信任门槛，降低退货率。",
    workImpact: "实战文案：主图 corner 印上【技適認証取得済・安心の日本国内対応】！",
    rewardAffinity: 30,
    rewardExp: 40,
    rewardCoins: 25,
  },
  {
    id: "q_copywriting_number_rule",
    category: "copywriting",
    categoryLabel: "数字冲击力法则",
    categoryEmoji: "🔢",
    question: "在短视频脚本中表达「电池续航长」时，哪种数字表达对消费者的购买决策最有效？",
    options: [
      "「拥有非常久的使用时间」",
      "「搭载了高密度电芯」",
      "「内置了超大毫安数」",
      "「1次充电 = 满电续航 15 天，彻底告别出差带充电线的烦恼」",
    ],
    correctIndex: 3,
    explanation: "空洞的形容词「很久」无法建立心理账户。具体数字「15天」+ 痛点场景「告别出差充电线」能够让消费者立刻算清楚时间价值并产生解脱感。",
    workImpact: "实战公式：【精准天数/克重】+【对比参照物】+【告别某种具体烦恼】！",
    rewardAffinity: 25,
    rewardExp: 35,
    rewardCoins: 20,
  },
